        ...
        <div class="main-header">
          ...
          <div class="header-logo"> 
            <a class="d-flex" href="{{ url('/') }}">
              <img alt="luxride" src="{{ asset($setting->logo) }}" class="navImg">
            </a>
          </div>
                      ...
                      <ul class="sub-menu">
                        ...
                        @foreach($subcategories as $subcategory)
                          ...
                          @foreach($subsubcategories as $subsubcategory)
                              <li><a href="{{ url('subsubcategory/product/'.$subsubcategory->id.'/'.$subsubcategory->subsubcategory_slug ) }}" style="font-size: 16px; color: #999; margin-top: -6px">
          ...
          <div class="header-account">
            <a class="account-icon search" href="#"  data-toggle="modal" data-target="#searchModal">
            ...
            <a class="account-icon account" @auth href="{{ route('dashboard') }}" @else href="{{ route('login') }}" @endauth>
              <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="account-icon wishlist" href="{{ route('wishlist') }}">
              <span class="number-tag" id="whistListQty">0</span>
              <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="account-icon cart" href="{{ route('mycart') }}">
              <span class="number-tag" id="cartQty">0</span>
    ...
    <div class="mobile-header-content-area">
        <div class="mobile-menu-head">
          <div class="box-head-1">
            <a class="link-underline mr-20 account-icon account" href="#">Jouda Indonesia</a>
            <a class="close-mobile" href="#"><img src="{{ asset('frontend/assets/images/close.svg') }}" alt="Guza"></a>
          </div>
          <div class="box-head-2"><a class="back-mobile" href="#"><img src="{{ asset('frontend/assets/images/back.svg') }}" alt="Guza"></a></div>
        </div>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('product.search') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" id="search" name="search" class="form-control" onfocus="search_result_show()" onblur="search_result_hide()"
                            placeholder="Masukkan Sesuatu">
                    </div>

                    <button class="btn btn-success" type="submit" style="margin-left: 17px;"> Cari </button>
